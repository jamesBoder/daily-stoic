  ...
  return (
    <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-sans ${
      isPremium
        ...
        : 'border-primary-200 dark:border-[rgba(255,255,255,0.08)] text-primary-600 dark:text-primary-600 bg-surface-card'
    }`}>
...
function Feature({ icon, title, description }: { icon: string; title: string; description: string }) {
  return (
    <div className="flex items-start gap-4">
      ...
      <div>
        <h3 className="font-display text-sm text-primary-800 dark:text-primary-800 mb-1">{title}</h3>
        <p className="font-sans text-sm text-primary-500 dark:text-primary-500 leading-relaxed">{description}</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="bg-surface-base page-utility min-h-screen">
      ...
      <section className="max-w-2xl mx-auto px-5 pt-16 pb-14 text-center">
        ...
        <h1 className="font-serif text-4xl md:text-5xl text-primary-900 dark:text-primary-900 leading-tight mb-5 title-glow-hover">
          Ancient wisdom.<br />One passage a day.
        </h1>
        <div className="w-10 border-t border-accent/40 mx-auto mb-6" />
        <p className="font-sans text-base text-primary-500 dark:text-primary-500 leading-relaxed max-w-md mx-auto">
        ...
        {showCTA && (
          <div className="mt-8 flex items-center justify-center gap-4">
            ...
            <Link
              to="/auth/login"
              className="font-sans text-sm text-primary-500 dark:text-primary-500 hover:text-accent transition-colors"
            >
              Sign in
            </Link>
          </div>
      ...
      <section className="max-w-2xl mx-auto px-5 py-12 border-t border-primary-200 dark:border-[rgba(255,255,255,0.07)]">
        ...
        <p className="font-sans text-sm text-primary-500 dark:text-primary-500 leading-relaxed mb-6">
        ...
        <section className="max-w-2xl mx-auto px-5 py-12 border-t border-primary-200 dark:border-[rgba(255,255,255,0.07)]">
          ...
          <div className="rounded-2xl border border-accent/25 bg-accent/5 dark:bg-accent/5 p-6">
            <div className="flex items-start gap-4 mb-5">
              ...
              <div>
                <h3 className="font-display text-base text-primary-800 dark:text-primary-800 mb-1">
            ...
            <ul className="space-y-2.5 mb-6">
              {[
                ...
                <li key={item} className="flex items-start gap-2.5 font-sans text-sm text-primary-600 dark:text-primary-600">
      ...
      <section className="max-w-2xl mx-auto px-5 py-12 border-t border-primary-200 dark:border-[rgba(255,255,255,0.07)]">
        ...
        <div className="space-y-4 font-sans text-sm text-primary-600 dark:text-primary-600 leading-relaxed">
          <p>
      ...
      <section className="max-w-2xl mx-auto px-5 py-12 border-t border-primary-200 dark:border-[rgba(255,255,255,0.07)]">
        ...
        <div className="space-y-3 font-sans text-sm text-primary-500 dark:text-primary-500">
          <p>
