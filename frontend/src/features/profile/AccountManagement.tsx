...
export const AccountManagement: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      {/* Clear History */}
      <Card>
        <h2 className="text-2xl font-bold mb-4 text-fg-muted text-center">
          {t("history.title")}
        </h2>
        <p className="text-fg-muted mb-4 text-center">
          {t("history.clearDesc")}
        </p>
      ...
      <Card>
        ...
        {!hasPassword && showSetPasswordForm && (
          <form onSubmit={handleSetPasswordSubmit} className="space-y-4">
            {newPasswordError && <div className="text-danger text-sm">{newPasswordError}</div>}
            {newPasswordSuccess && (
      ...
      <Card>
        ...
        {/* Error message */}
        {googleError && (
          <div className="mb-4 p-3 bg-danger-bg border border-[var(--color-danger)] rounded text-danger text-sm">
            {googleError}
          </div>
        )}
        ...
        {user?.is_google_linked ? (
          <div className="border border-border rounded-lg p-4">
            <div className="flex flex-col items-center justify-center gap-4">
              ...
              {!showUnlinkConfirm ? (
                ...
                <div className="w-full p-3 bg-warning/10 border border-warning/40 rounded">
                  <p className="text-sm text-warning mb-3 text-center">
                    {t('account.unlinkConfirm')}
                  </p>
                  <div className="flex gap-2 justify-center">
                    <Button onClick={handleUnlinkGoogle} isLoading={isUnlinkingGoogle} className="bg-warning hover:bg-[var(--color-warning)] text-accent-text text-sm">
                      {t('account.yesUnlink')}
                    </Button>
          ...
          <div className="border border-border rounded-lg p-6 text-center">
            <div className="w-16 h-16 bg-surface-hi rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-fg-subtle" viewBox="0 0 24 24">
                <path
                  fill={BRAND.googleBlue}
                  d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                />
      ...
      {/* Delete Account */}
      <Card>
        <h2 className="text-2xl font-bold mb-4 text-danger text-center">
        ...
        {!showDeleteConfirm ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-danger-bg border border-[var(--color-danger)] rounded p-4">
