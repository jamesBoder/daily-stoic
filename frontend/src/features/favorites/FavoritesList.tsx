    ...
    >
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`${btnBase} ${
            isCopied
              ? "bg-success text-accent-text focus:ring-success"
        ...
        <button
          ...
          className={`${btnBase} bg-[var(--color-brand-x)] text-white hover:bg-[var(--color-brand-x-hover)] focus:ring-[var(--color-brand-x)]`}
        >
        ...
        <button
          ...
          className={`${btnBase} bg-[var(--color-brand-whatsapp)] text-white hover:bg-[var(--color-brand-whatsapp-hover)] focus:ring-[var(--color-brand-whatsapp)]`}
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          className={`${btnBase} bg-[var(--color-brand-facebook)] text-white hover:bg-[var(--color-brand-facebook-hover)] focus:ring-[var(--color-brand-facebook)]`}
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          className={`${btnBase} bg-gradient-to-br from-[var(--color-brand-instagram-from)] via-[var(--color-brand-instagram-via)] to-[var(--color-brand-instagram-to)] text-white hover:opacity-90 focus:ring-[var(--color-brand-instagram-via)]`}
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        {supportsNativeShare && (
          <button
            ...
            className={`${btnBase} bg-accent text-accent-text hover:bg-accent-dark focus:ring-accent`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-danger-bg border border-[var(--color-danger)] rounded-card p-6 text-center">
